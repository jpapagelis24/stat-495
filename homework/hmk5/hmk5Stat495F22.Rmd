...
```{r, warning = FALSE}
ggplot(data = kchouse, aes(x = yr_renovated, y = price)) + 
  geom_point() + 
  labs(title = "Scatterplot of Year Renovated and Price", x = "Year Renovated",
       y = "Price")
ggplot(data = kchouse, aes(x = sqft_basement, y = price)) + 
  geom_point() + 
...
```{r}
ggplot(data = kchouse, aes(x = date, y = price)) + 
  geom_point() + 
...
```{r}
ggplot(data = kchouse, aes(x = id, y = price)) + 
  geom_point() + 
...
ggplot(data = kchouse, aes(x = sqft_living, y = sqft_above)) + 
  geom_point() + 
...
```{r}
ggplot(data = kchouse, aes(x = sqft_living, y = sqft_living15)) + 
  geom_point() + 
