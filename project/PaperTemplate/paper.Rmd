...
```{r run simulation log normal, include = FALSE}
...
```{r run simulation beta, include = FALSE}
...
```{r collect data log normal, include = FALSE}
...
```{r collect data beta, include = FALSE}
...
gamma_data <- collect_data_gamma(sim_reps)
write.csv(gamma_data1,"gamma_data1.csv", row.names = FALSE)

normal_data <- collect_data_normal(sim_reps)
write.csv(normal_data1,"normal_data1.csv", row.names = FALSE)
```

```{r, include = FALSE, eval = FALSE}
#beta_data11 <- collect_data_beta(sim_reps)
#write.csv(beta_data1,"beta_data1_100002.csv", row.names = FALSE)


log_normal_data <- collect_data_log_normal(sim_reps)
write.csv(log_normal_data1,"log_normal_data1.csv", row.names = FALSE)
