...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{run\_simulation\_log\_normal }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(simulation\_rep)\{}
\NormalTok{  trueparameter }\OtherTok{\textless{}{-}} \FunctionTok{exp}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}

\NormalTok{  X }\OtherTok{\textless{}{-}} \FunctionTok{rlnorm}\NormalTok{(sample\_sizes, }\AttributeTok{meanlog =} \DecValTok{0}\NormalTok{, }\AttributeTok{sdlog =} \DecValTok{1}\NormalTok{)}
\NormalTok{  values }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(X)}
\NormalTok{  output }\OtherTok{\textless{}{-}} \FunctionTok{findCIs}\NormalTok{(values, }\DecValTok{2000}\NormalTok{)}
\NormalTok{  ci }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{c}\NormalTok{(trueparameter }\SpecialCharTok{\textgreater{}=}\NormalTok{ output}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Standard Interval}\StringTok{\textasciigrave{}}\NormalTok{[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{\&} 
\NormalTok{    trueparameter }\SpecialCharTok{\textless{}=}\NormalTok{ output}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Standard Interval}\StringTok{\textasciigrave{}}\NormalTok{[}\DecValTok{2}\NormalTok{],}
...
Lastly, we sample from a Beta distribution with shape parameters of 4
and 1 which gives us a true population mean of 0.8.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{run\_simulation\_beta }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(simulation\_rep)\{}
\NormalTok{  trueparameter }\OtherTok{\textless{}{-}} \FloatTok{0.8}
  
\NormalTok{  X }\OtherTok{\textless{}{-}} \FunctionTok{rbeta}\NormalTok{(sample\_sizes, }\AttributeTok{shape1 =} \DecValTok{4}\NormalTok{, }\AttributeTok{shape2 =} \DecValTok{1}\NormalTok{)}
\NormalTok{  values }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(X)}
\NormalTok{  output }\OtherTok{\textless{}{-}} \FunctionTok{findCIs}\NormalTok{(values, }\DecValTok{2000}\NormalTok{)}
\NormalTok{  ci }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{c}\NormalTok{(trueparameter }\SpecialCharTok{\textgreater{}=}\NormalTok{ output}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Standard Interval}\StringTok{\textasciigrave{}}\NormalTok{[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{\&} 
\NormalTok{    trueparameter }\SpecialCharTok{\textless{}=}\NormalTok{ output}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Standard Interval}\StringTok{\textasciigrave{}}\NormalTok{[}\DecValTok{2}\NormalTok{],}
